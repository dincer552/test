...
COPY src/main/java/web/PlayerWebApplicationFixed.java src/main/java/web/PlayerWebApplicationFixed.java
...
RUN apt-get update \
    ...
    && javac -cp "lib/*" -d classes src/main/java/core/net/HattrickAPI.java src/main/java/web/WebApplication.java src/main/java/web/PlayerWebApplicationFixed.java
...
CMD ["java", "-cp", "/app/classes:/app/lib/*", "web.PlayerWebApplicationFixed"]
